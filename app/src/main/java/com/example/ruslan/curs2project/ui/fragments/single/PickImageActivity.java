...
import com.example.ruslan.curs2project.utils.ValidationUtil;
import com.theartofdev.edmodo.cropper.CropImage;
import com.theartofdev.edmodo.cropper.CropImageView;

import java.io.File;

public abstract class PickImageActivity extends NavigationBaseActivity {
...
//                }
    ...
    protected void startCropImageActivity() {
        ...
        CropImage.activity(imageUri)
                ...
                .setMinCropResultSize(Const.Profile.MIN_AVATAR_SIZE, Const.Profile.MIN_AVATAR_SIZE)
                .setRequestedSize(Const.Profile.MAX_AVATAR_SIZE, Const.Profile.MAX_AVATAR_SIZE)
                .start(this);
    }
}
