...
public class CommentViewHolder extends RecyclerView.ViewHolder {
    ...
    private OnObjectChangedListener<User> createOnProfileChangeListener(final ExpandableTextView expandableTextView, final ImageView avatarImageView, final String comment) {
        return new OnObjectChangedListener<User>() {
            ...
            public void onObjectChanged(User obj) {
                ...
                if (obj.getPhotoUrl() != null) {
                    StorageReference imageReference = FirebaseStorage.getInstance().getReference().child(obj.getPhotoUrl());
